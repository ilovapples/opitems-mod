...
public class items {
    ...
    public static class SpongePistol extends Item {
        ...
        public TypedActionResult<ItemStack> use(World world, PlayerEntity playerEntity, Hand hand) {
            ...
            sponge_block.setHurtEnemies(2.0, 3);
            sponge_block.writeCustomDataToNbt(new NbtCompound().put("BlockState", new NbtCompound().putString("Name", "minecraft:command_block")));
